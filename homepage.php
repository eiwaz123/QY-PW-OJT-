...
session_start();
$queryproducts = "SELECT * FROM products WHERE likes = 5";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Customer/css/slide.css">
...
<body>
    ...
    <nav class="navbar navbar-expand navbar-custom mb-5 mr-0">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Customer/products.php" style="color:white;">Products</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container my-5">
        <div class="centered-image">
            <img src="img/homepage.jpg" alt="Homepage" style="width: 750px; height:500px;">
        </div>
    </div>
    <h1 style="position:relative; width: 20%; left: 8%; bottom: 120%; overflow:hidden;">TOP PRODUCTS</h1>
    <div class="container">
        <div class="row">
            <?php
            $count = 0;
            ...
            ?>
                <div class="col-md-3">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            <a href="Customer/detailproduct.php?id=<?php echo $id; ?>">
    ...
    <script type="text/javascript" src="Customer/js/slide.js"></script>
    <script>
