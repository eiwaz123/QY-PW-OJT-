...
<div>
    ...
    <nav class="navbar navbar-expand navbar-custom mb-5 mr-0">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-brand" href="../qy printwork.html" style="color:white;">QY Printwork</a>
    ...
    <!-- CAROUSEL PRODUCT -->
    <div class="row">
        <div class="card col border-0 mt-5" style="width:18rem;">
            <?php
