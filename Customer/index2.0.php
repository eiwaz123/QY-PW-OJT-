...
<body>
    ...
    <nav class="navbar navbar-expand navbar-custom mb-5 mr-0">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-brand" href="#" style="color:white;">QY Printwork</a>
            <ul class="navbar-nav mr-au  to mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="#" style="color:white;">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index2.0.php" style="color:white;">Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="signin.php" style="color:white;">Sign in</a>
                </li>
                <li class="nav-item form-inline my-2 my-sm-0">
