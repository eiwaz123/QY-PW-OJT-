            ...
            <div class="container h-100">
                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form  action="/process/registerprocess.php" method="post"   class="mx-1 mx-md-4" autocomplete="off">
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" name="yourname" id="form3Example1c" class="form-control" required/>
                ...
                ?>
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="username" name="username" id="form3Example3c" class="form-control" required/>
